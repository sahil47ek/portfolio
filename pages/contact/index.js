...
const Contact = () => {
  return (
    <div className='min-h-screen bg-primary/30 md:py-32 py-20 flex items-center'>
      <div className='container mx-auto'>
        <div className='flex flex-col items-center'>
          ...
          <motion.div
            ...
            animate='show'
            exit='hidden'
            className='grid grid-cols-1 md:grid-cols-2 gap-6 md:mb-12 mb-4 w-full max-w-[800px]'
          >
            {/* Email Box */}
