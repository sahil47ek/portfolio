  ...
  return (
    <div className='min-h-screen bg-primary/30 py-16 md:py-24'>
      <div className='container mx-auto px-4 md:px-8'>
        ...
        >
          {/* Project Title */}
          <h1 className='h1 text-center mb-8 md:mb-12'>{project.title}</h1>
            ...
            <div className='space-y-8'>
              ...
              <div className='flex flex-wrap gap-4'>
                <Link
                  ...
                  target='_blank'
                  className='btn rounded-full border border-white/50 px-8 py-3 transition-all duration-300 flex items-center gap-x-2 hover:border-accent group'
                >
                  <span>Visit Website</span>
                  <RiExternalLinkLine className='text-xl group-hover:text-accent' />
                </Link>
                <Link
                ...
                >
                  <span>View Code</span>
                  <RiGitlabLine className='text-xl group-hover:text-accent' />
                </Link>
              </div>
              ...
              {/* Features */}
              <div>
                <h3 className='h3 text-accent mb-4'>Key Features</h3>
